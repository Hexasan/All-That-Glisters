advancement revoke @s only allthatglisters:use_golden_cornflower
...
execute anchored eyes run function allthatglisters:cornflower/raycast
...
execute if predicate allthatglisters:mainhand_cornflower run return run item modify entity @s weapon.mainhand allthatglisters:remove_one
